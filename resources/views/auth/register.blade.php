<x-guest-layout>
    <!-- Tombol Silang untuk Kembali -->
    <div class="relative">
        <a href="{{ url()->previous() }}"
           class="absolute -top-2 -right-2 w-8 h-8 flex items-center justify-center rounded-full bg-gray-100 hover:bg-gray-200 text-gray-600 hover:text-gray-800 transition-colors duration-200"
           title="Kembali">
    ...
    <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
        ...
        <div class="mt-4">
            ...
            <div class="relative">
                ...
                <!-- Tombol Mata untuk Confirm Password -->
                <button type="button"

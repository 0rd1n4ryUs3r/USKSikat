        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <h2 class="text-2xl font-bold mb-6">Edit Soal Test</h2>

                    <form action="{{ route('admin.soal-test.update', $soalTest) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PATCH')

                        <div class="mb-6">
                            <label for="pertanyaan" class="block text-sm font-semibold text-gray-700 mb-2">Pertanyaan</label>
                            <textarea id="pertanyaan" name="pertanyaan" rows="3" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 @error('pertanyaan') border-red-500 @enderror" required>{{ old('pertanyaan', $soalTest->pertanyaan) }}</textarea>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                            <div>
                                ...
                                <input type="text" id="pilihan_a" name="pilihan_a" value="{{ old('pilihan_a', $soalTest->pilihan_a) }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 @error('pilihan_a') border-red-500 @enderror" required>
                            ...
                            <div>
                                ...
                                <input type="text" id="pilihan_b" name="pilihan_b" value="{{ old('pilihan_b', $soalTest->pilihan_b) }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 @error('pilihan_b') border-red-500 @enderror" required>
                            ...
                            <div>
                                ...
                                <input type="text" id="pilihan_c" name="pilihan_c" value="{{ old('pilihan_c', $soalTest->pilihan_c) }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 @error('pilihan_c') border-red-500 @enderror" required>
                            ...
                            <div>
                                ...
                                <input type="text" id="pilihan_d" name="pilihan_d" value="{{ old('pilihan_d', $soalTest->pilihan_d) }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 @error('pilihan_d') border-red-500 @enderror" required>
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" id="pilihan_e" name="pilihan_e" value="{{ old('pilihan_e', $soalTest->pilihan_e) }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 @error('pilihan_e') border-red-500 @enderror">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                            <div>
                                ...
                                <select id="jawaban_benar" name="jawaban_benar" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 @error('jawaban_benar') border-red-500 @enderror" required>
                                    ...
                                    <option value="a" @selected(old('jawaban_benar', $soalTest->jawaban_benar) == 'a')>A</option>
                                    <option value="b" @selected(old('jawaban_benar', $soalTest->jawaban_benar) == 'b')>B</option>
                                    <option value="c" @selected(old('jawaban_benar', $soalTest->jawaban_benar) == 'c')>C</option>
                                    <option value="d" @selected(old('jawaban_benar', $soalTest->jawaban_benar) == 'd')>D</option>
                                    <option value="e" @selected(old('jawaban_benar', $soalTest->jawaban_benar) == 'e')>E</option>
                                </select>
                            ...
                            <div>
                                ...
                                <select id="kategori" name="kategori" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 @error('kategori') border-red-500 @enderror" required>
                                    <option value="">Pilih</option>
                                    <option value="matematika" @selected(old('kategori', $soalTest->kategori) == 'matematika')>Matematika</option>
                                    <option value="bahasa_inggris" @selected(old('kategori', $soalTest->kategori) == 'bahasa_inggris')>Bahasa Inggris</option>
                                    <option value="logika" @selected(old('kategori', $soalTest->kategori) == 'logika')>Logika</option>
                                    <option value="umum" @selected(old('kategori', $soalTest->kategori) == 'umum')>Umum</option>
                                </select>
                        ...
                        <div class="mb-6">
                            ...
                            <textarea id="penjelasan" name="penjelasan" rows="3" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 @error('penjelasan') border-red-500 @enderror">{{ old('penjelasan', $soalTest->penjelasan) }}</textarea>
                            @error('penjelasan') <p class="text-red-600 text-sm mt-2">{{ $message }}</p> @enderror
                        </div>

                        <div class="flex gap-3">
                            <button type="submit" class="bg-blue-600 text-white px-6 py-2 rounded-lg hover:bg-blue-700 transition font-semibold">Perbarui</button>
